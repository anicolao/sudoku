...
describe('progress transfer codec', () => {
  it('round-trips the stable, bounded V1 binary representation', () => {
    ...
    expect(encoded).toBe('');
  });

  it('defaults the new Notes preference off for an older V1 transfer', () => {
    const encoded = '';
    expect(decodeTransfer(encoded).settings.notesFirst).toBe(false);
  });
